...
import 'package:proconnectnb/models/aine.dart';
...
import '../screens/rappel/add_rappel_screen.dart';
import '../screens/rappel/rappel_list_screen.dart';
...
class AppRouter {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case '/rappel':
         return MaterialPageRoute(builder: (_) => const RappelListScreen());

      case '/add-rappel':
        return MaterialPageRoute(builder: (_) => const AddRappelScreen());
      ...
      case '/addAine':
        return MaterialPageRoute(builder: (_) => const AddAineScreen());
      ...
      //PARTAGE
      case '/partageAine':
        final aine = settings.arguments is Aine
            ? settings.arguments as Aine
            : null;
