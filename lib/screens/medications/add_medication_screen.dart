...
class _AddMedicationScreenState extends State<AddMedicationScreen> {
  ...
  Future<void> _deleteMedication() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
            "Cette action est irréversible. Voulez-vous vraiment supprimer ce traitement ?",
    ...
    try {
      ...
      if (success) {
        _showSnackBar("Traitement supprimé");
        Navigator.pop(context);
      } else {
      ...
      child: Column(
        ...
        children: [
          ...
          SwitchListTile(
            ...
            subtitle: const Text(
              "Si activé, ce médicament apparaîtra dans la liste des rappels.",
